    ...
    .then((querySnapshot) => {
        querySnapshot.forEach((docdata) => {
            ...
            .then(() => {
                ...
                updateDoc(docRef,{profilephotourl:'https://firebasestorage.googleapis.com/v0/b/make-even-d50ab.appspot.com/o/user.png?alt=media&token=a9ed9591-caab-4743-999d-a68810177340'})
                // userdetails();
                // saveuserdetails(e);
            })
            .catch((error) => {
